...
{
    function generate_random_digits_with_specefic_length(int $length): int
    {
        return (int) substr(number_format(time() * rand(), 0, '', ''), 0, $length);
    }
}

function validate_national_id(string $national_id, string $country = 'IR'): bool
{
    if($country == 'IR')
    {
